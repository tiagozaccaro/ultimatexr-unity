...
namespace UltimateXR.Editor.Core.Instantiation
{
    ...
    public class UxrInstanceManagerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox("Use prefab lists to keep big projects well organized. To create a new prefab list use the Create->UltimateXR menu in the Project Window.", MessageType.Info);
